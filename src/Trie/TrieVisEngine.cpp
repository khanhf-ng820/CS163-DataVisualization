...
// 	events.push_back(TrieAnimStep(TrieAnimType::NONE, "Before deleting key " + std::to_string(key), {}, key, 0));
...
// 	events.push_back(TrieAnimStep(TrieAnimType::NONE, "Finished deleting key " + std::to_string(key), {}, key, oldTreeSnapshots.size() -1));
