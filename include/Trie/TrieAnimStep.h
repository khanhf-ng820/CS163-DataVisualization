...
public:
	TrieAnimStep();
	TrieAnimStep(TrieAnimType type, std::string description, std::vector<int> highlightCodeLineIndex);
	TrieAnimStep(TrieAnimType type, std::string description, std::vector<int> highlightCodeLineIndex, int curID);
	TrieAnimStep(TrieAnimType type, std::string description, std::vector<int> highlightCodeLineIndex, int curID, int oldTreeSnapshotIndex);
